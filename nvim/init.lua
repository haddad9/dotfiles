...
-- Sync clipboard between OS and *NEOVIDE*.
--  Remove this option if you want your OS clipboard to remain independent.
--
...
-- keybinnd to show the docs of the paramater
...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    dependencies = {
      ...
      -- Allows extra capabilities provied by nvim-cmp
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          -- NOTE: Remember that Lua is a real programming language, and as such it is possibleini
          ...
          map('[d', vim.diagnostic.goto_prev, 'goto prev diag')
          map(']d', vim.diagnostic.goto_next, 'goto next diag')

          -- Execute a code action, usually your cursor needs to be on top of an error
          -- or a suggestion from your LSP for this to activate.
          map('<leader>ca', vim.lsp.buf.code_action, '[C]ode [A]ction', { 'n', 'x' })
          -- WARN: This is not Goto Definition, this is Goto D.get_next)
  ...
  { -- You can easily change to a different colorscheme.
    ...
    -- dir = vim.fn.stdpath 'config' .. '/dev/sirious-black',
    -- name = 'sirious-black',
    -- lazy = false,
  ...
  { import = 'custom.plugins.compile-mode' },
